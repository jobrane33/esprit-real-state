...
public class LoginActivity extends AppCompatActivity {
    ...
    private void navigateToNextActivity() {
        Intent intent = new Intent(LoginActivity.this, UsserProfileActivit.class);
        startActivity(intent);
        finish();
// Optional, to prevent the user from going back to the login page using the back button
    }
